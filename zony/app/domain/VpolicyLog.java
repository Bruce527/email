...
// Source File Name:   VpolicyLog.java

package com.zony.app.domain;


public class VpolicyLog
{
	...
	private String outdateStatusName;
	...
	public String getOutdateStatusName()
	{
		return outdateStatusName;
	}

	public void setOutdateStatusName(String outdateStatusName)
	{
		this.outdateStatusName = outdateStatusName;
	}
