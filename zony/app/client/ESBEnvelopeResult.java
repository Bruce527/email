	...
	implements Serializable
{
	...
	static 
	{
		typeDesc = new TypeDesc(com/zony/app/client/ESBEnvelopeResult, true);
		typeDesc.setXmlType(new QName("http://MetLifeEAI.EAISchema", ">ESBEnvelopeResult"));
		ElementDesc elemField = new ElementDesc();
		elemField.setFieldName("ESBHeader");
		elemField.setXmlName(new QName("", "ESBHeader"));
		elemField.setXmlType(new QName("http://MetLifeEAI.EAISchema", ">>ESBEnvelopeResult>ESBHeader"));
		...
		elemField.setXmlType(new QName("http://MetLifeEAI.EAISchema", ">>ESBEnvelopeResult>MsgBody"));
		elemField.setMinOccurs(0);
		elemField.setNillable(false);
		typeDesc.addFieldDesc(elemField);
	}
