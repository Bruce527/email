...
// Source File Name:   ESBEnvelopeESBHeader.java
	...
	implements Serializable
{
	...
	public ESBEnvelopeESBHeader(String ESBHdVer, Date srvDate, Time srvTime, String senderID, String receiverID, String srvOpName, String srvOpVer, 
	...
	{
		if (!(obj instanceof ESBEnvelopeESBHeader))
			return false;
		ESBEnvelopeESBHeader other = (ESBEnvelopeESBHeader)obj;
		if (obj == null)
			return false;
		if (this == obj)
			return true;
	...
	{
		return (new StringBuilder("ESBEnvelopeESBHeader [ESBHdVer=")).append(ESBHdVer).append(", srvDate=").append(srvDate).append(", srvTime=").append(srvTime).append(", senderID=").append(senderID).append(", receiverID=").append(receiverID).append(", srvOpName=").append(srvOpName).append(", srvOpVer=").append(srvOpVer).append(", msgID=").append(msgID).append(", corrID=").append(corrID).append(", ESBRspCode=").append(ESBRspCode).append(", ESBRspDec=").append(ESBRspDec).append(", resField1=").append(resField1).append(", resField2=").append(resField2).append(", resField3=").append(resField3).append(", resField4=").append(resField4).append(", resField5=").append(resField5).append(", __equalsCalc=").append(__equalsCalc).append(", __hashCodeCalc=").append(__hashCodeCalc).append("]").toString();
	}

	static 
	{
		typeDesc = new TypeDesc(com/zony/app/client/ESBEnvelopeESBHeader, true);
		typeDesc.setXmlType(new QName("http://MetLifeEAI.EAISchema", ">>ESBEnvelope>ESBHeader"));
		...
		elemField.setXmlType(new QName("http://www.w3.org/2001/XMLSchema", "time"));
		elemField.setNillable(false);
		typeDesc.addFieldDesc(elemField);
		elemField = new ElementDesc();
